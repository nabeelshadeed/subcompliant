...
export const metadata: Metadata = {
  title: 'Constructionline Alternative — SubCompliant | Subcontractor Compliance Software UK',
  description: "Looking for a Constructionline alternative that manages your subcontractors' compliance daily? SubCompliant tracks documents, sends expiry alerts, and generates HSE reports. From £39/month.",
}

export default function ConstructionlineAlternativePage() {
  return (
    <main>
      <div className="container">
        <nav className="breadcrumb" aria-label="Breadcrumb">
          <Link href="/">Home</Link><span>›</span><span>Constructionline Alternative</span>
        </nav>
      </div>
      <section className="alt-hero">
        <div className="container">
          <div className="alt-tag">Constructionline Alternative</div>
          <h1>Constructionline proves <em>your</em> compliance.<br />SubCompliant manages <em>theirs.</em></h1>
          <p>Constructionline was built for procurement — to help you get on approved lists. SubCompliant was built for operations — to help you manage every subcontractor&apos;s documents, every day, automatically.</p>
        ...
        <div className="container">
          ...
          <div className="comp-grid">
            <div className="comp-card them">
              <div className="comp-card-label them-lbl">✗ Constructionline</div>
              <h3>Proves your own compliance to buyers</h3>
              <div className="comp-pts">
                <div className="comp-pt"><span className="comp-pt-ico">📅</span>Annual accreditation — you submit once per year and get a certificate</div>
                <div className="comp-pt"><span className="comp-pt-ico">💰</span>£249–£2,299/year based on your turnover</div>
                <div className="comp-pt"><span className="comp-pt-ico">⏳</span>2–6 weeks to complete the onboarding process</div>
        ...
        <div className="container">
          ...
          <div style={{ overflowX: 'auto' }}>
            <table className="feat-table">
              <thead><tr><th>Capability</th><th>Constructionline</th><th>SubCompliant</th></tr></thead>
              <tbody>
                <tr><td>Your own compliance accreditation</td><td className="ct-y">✓ Core feature</td><td className="ct-w">Not required — we complement this</td></tr>
                ...
                <tr><td>Monthly cost (SME)</td><td className="ct-w">£21–£192/mo</td><td className="ct-y">From £39/mo</td></tr>
                <tr><td>Time to set up</td><td className="ct-w">2–6 weeks</td><td className="ct-y">Under 10 minutes</td></tr>
              </tbody>
            </table>
          </div>
        </div>
      ...
      <section className="section alt-bg">
        <div className="container">
          ...
          <div className="why-grid">
            <div className="why-card"><div className="why-ico">⚡</div><h3>Built for daily use, not annual submissions</h3><p>Constructionline is a once-a-year accreditation. SubCompliant is open every day — tracking renewals, alerting you to risks, and keeping your supply chain visible at all times.</p></div>
            <div className="why-card"><div className="why-ico">💷</div><h3>Priced for SMEs, not enterprise</h3><p>Start at £39/month with no setup fees. Constructionline pricing starts at £249/year and rises significantly for contractors above small turnover thresholds.</p></div>
            <div className="why-card"><div className="why-ico">🛡️</div><h3>Protects you from your subcontractors&apos; lapses</h3><p>Constructionline proves you&apos;re compliant. SubCompliant ensures your subcontractors stay compliant — which is the gap that causes HSE incidents, insurance voids, and contract disputes.</p></div>
          </div>
        </div>
      </section>
